      ...
      slivers: <Widget>[
        ...
        SliverFillRemaining(
          child: ListView.builder(
            ...
            itemCount: widget.province.institutions.length,
            itemBuilder: (BuildContext context, int index) {
              Institution institution = widget.province.institutions[index];
              return Stack(
                children: <Widget>[
                  Container(
...
//                                    ),
                          ...
                          _buildRatingStars(institution.rating),
                          SizedBox(height: 5.0),
                          Row(
                            children: <Widget>[
                              Container(
