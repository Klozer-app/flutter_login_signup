                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text("Raja Ampat The Hidden Place",
                        maxLines: 2,
                    ...
                    Padding(
                      padding: EdgeInsets.only(top: 19.2),
                      child: Text("Raja Ampat is one of the favorite tourist destination, you can feel cultural tourism and history to explore exotic beaches in Raja Ampat",
                        maxLines: 3,
