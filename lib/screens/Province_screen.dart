...
import 'package:flutter_login_signup/models/universities_model.dart';
        ...
        children: <Widget>[
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemCount: widget.province.universities.length,
              itemBuilder: (BuildContext context, int index) {
                University university = widget.province.universities[index];
                return Stack(
                  children: <Widget>[
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            _buildRatingStars(university.rating),
